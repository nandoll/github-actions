...
export default function aprendizaje({ posts, cats }) {
  ...
  const data = { 
    ...
    content: "En esta edición, tuvimos un panel con Aurelia Alvarado, Gerente de Experiencia al Usuario en Innova Schools y Álvaro Valdez, Director Académico General de la UTP quienes contaron principales aprendizajes de la educación virtual."
  }
  const settings = {
    dots: false,
    infinite: true,
  ...
  return (
    <MainLayout>    
      ...
      <div className="container">
        <h1 className="my-10 text-3xl font-serif text-blue-500"> Conoce más </h1>
        <Slider {...settings}>
            {                
              noticias.map( post => (
                <PostCard
          ...
          <Link href="/noticias">
            <a className="inline-block border border-dotted rounded-full mx-10 mb-20 py-2 px-10 border-blue-500 text-blue-500">Ver más noticias</a>
          </Link>
      </div>
              ...
              <div className="flex flex-wrap">
                <div className="p-4 md:w-1/5">
                  <div className="w-full">
                    ...
                    <p className="text-white text-sm my-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                  </div>  
                </div> 
                <div className="p-4 md:w-1/5">
                  <div className="w-full">
      ...
      <div className="bg-yellow-500 px-10 py-10">
