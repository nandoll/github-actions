...
class FooterDark extends Component {
  ...
  render() {
    return (
      <>
        <footer
          className="bg-black text-white relative z-20 py-12"
          id="footer-main"
        >
              ...
              <div className="w-3/4 sm:w-full flex flex-row flex-wrap">
                  ...
                  <div className="w-full sm:w-1/2 lg:w-1/3 text-xs mb-3 sm:mb-0">
                    ...
                    <nav className="underline flex flex-col text-gray-200">
                      <a
                        href="#"
                        className="block mb-1"
                        title="Empresas de Intercorp y socios"
                      >
                        Empresas de Intercorp y socios
                      </a>
                      <a
                        href="#"
                        className="block mb-1"
                ...
                <div className="w-full">
                  <a
                    ...
                    href="#"
                    target="_blank"
                    title="Intercorp Linkedin"
                  >
                    <i className="icon-linkedin text-lg"></i>
                  </a>
                  <br />
                  <p className="text-xs">
                    © 2018 Intercorp. All Rights Reserved.
                  </p>
                </div>
              </div>
            </div>
